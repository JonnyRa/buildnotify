...
class DistanceOfTime(object):
    ...
    def age(self):
        ...
        distance_in_minutes = int(distance_in_seconds // 60)

        buckets = [(1, "1 minute"),
                   (45, "%s minutes" % distance_in_minutes),
                   (90, "1 hour"),
                   (1440, "%d hours" % (distance_in_minutes // 60.0)),
                   (2880, "1 day"),
                   (43220, "%d days" % (distance_in_minutes // 1440)),
                   (86400, "1 month"),
                   (525600, "%d months" % (distance_in_minutes // 43200)),
                   (1051200, "1 year")]
        default_bucket = "over %d years" % (distance_in_minutes // 525600)
